...
export default function EnhancedTable() {
  ...
  useEffect(()=>{
    ...
    (async() => {
      Volunteer.getVolunteer().then(res => {
    ...
    <div className="mb-5">
      <div className=" clearfix mt-0 mb-5">
        <span class=" float-left col-6">
          ...
          <h4>
            Volunteer{" "}
            <a class="btn badge badge-pill badge-primary" onClick={gotoAddVolunteer}>Add new Volunteer</a>
          </h4>{" "}
        </span>
                  ...
                  return (
                    <TableRow
                      ...
                      onClick={(e)=>{   history.push({
                        pathname: '/manager/volunteer/edit',
